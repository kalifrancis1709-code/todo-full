...
config.runtimeDataModel = JSON.parse("{\"models\":{\"taches\":{\"fields\":[{\"name\":\"id\",\"kind\":\"scalar\",\"type\":\"Int\"},{\"name\":\"designation\",\"kind\":\"scalar\",\"type\":\"String\"}],\"dbName\":null}},\"enums\":{},\"types\":{}}")
config.parameterizationSchema = {
  strings: JSON.parse("[\"where\",\"taches.findUnique\",\"taches.findUniqueOrThrow\",\"orderBy\",\"cursor\",\"taches.findFirst\",\"taches.findFirstOrThrow\",\"taches.findMany\",\"data\",\"taches.createOne\",\"taches.createMany\",\"taches.createManyAndReturn\",\"taches.updateOne\",\"taches.updateMany\",\"taches.updateManyAndReturn\",\"create\",\"update\",\"taches.upsertOne\",\"taches.deleteOne\",\"taches.deleteMany\",\"having\",\"_count\",\"_avg\",\"_sum\",\"_min\",\"_max\",\"taches.groupBy\",\"taches.aggregate\",\"AND\",\"OR\",\"NOT\",\"id\",\"designation\",\"equals\",\"in\",\"notIn\",\"lt\",\"lte\",\"gt\",\"gte\",\"contains\",\"startsWith\",\"endsWith\",\"not\",\"set\",\"increment\",\"decrement\",\"multiply\",\"divide\"]"),
...
/**
   ...
   * `prisma.taches`: Exposes CRUD operations for the **taches** model.
    ...
    * ```
    */
  get taches(): Prisma.tachesDelegate<ExtArgs, { omit: OmitOpts }>;
}
